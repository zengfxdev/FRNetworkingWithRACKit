...
typedef NS_ENUM(NSUInteger, FRApiResponseStatus)
{
    ...
    FRApiResponseStatus_ErrorServer,     // 服务端错误
    FRApiResponseStatus_ErrorServer_DataError,      // 服务端错误_数据异常
    FRApiResponseStatus_ErrorServer_TokenBlcakList   // 服务端错误_Token被加入黑名单
};
